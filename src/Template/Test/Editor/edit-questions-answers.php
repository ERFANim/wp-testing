...
<tbody ng-repeat="question in questions" class="wpt_question" ng-init="questionIndex = $index">
    ...
    <tr>
        ...
        <td colspan="5" class="wpt_individual_action">
            ...
            <span class="note"><?php echo sprintf(__('— unique to each question. If you have same answers to all test questions, use the %s', 'wp-testing'), '<a href="#wpt_answerdiv" ng-click="highlight(\'#wpt_answerdiv\')">پاسخ آزمون</a>') ?></span>
        </td>
    </tr>
</tbody>
