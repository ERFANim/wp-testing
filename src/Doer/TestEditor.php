...
class WpTesting_Doer_TestEditor extends WpTesting_Doer_AbstractEditor
{
    ...
    public function customizeUi($screen)
    {
        ...
        $this->wp
            ->addMetaBox('woocommerce', 'اطلاعات آزمون برای خرید',    array($this, 'orderForTests'), 'wpt_test')
            ...
            ->addMetaBox('wpt_test_page_options','تنظیمات صفحه آزمون ',
    ...
    {
        $this->output('Test/Editor/order-tests');
    }
    ...
    private function addTestPageOptions()
    {
        $options = array(
            ...
            'wpt_test_page_user_is_login' => array(
                'default' => '0',
                'title'   => 'فقط اعضای سایت اجازه انجام این آزمون را داشته باشند',
            ),
    ...
    private function addResultPageOptions()
    {
        $options = array(
            ...
            'wpt_result_page_show_test_description' => array(
                'default' => '0',
                'title'   => 'نمایش توضیحات آزمون',
            ),
            'wpt_result_page_rowShowScales' => array(
                'default' => '1',
                'title'   => 'نمایش مقیاس ها در دو ستون',
            ),
        );
