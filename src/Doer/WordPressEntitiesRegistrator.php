    ...
    public function __construct(WpTesting_WordPressFacade $wp)
    {
        ...
        $wp->registerPostType('wpt_test', array(
            'labels'        => array(
                ...
                'edit_item'          => 'ویرایش أزمون',
                'view_item'          => 'مشاهده آزمون',
                'search_items'       => 'جستجوی آزمون',
                'parent_item_colon'  => 'آزمون مادر',

                'menu_name'          => 'آزمون ها',
                'all_items'          => 'همه آزمون ها',
                'update_item'        => 'به‌روزرسانی آزمون',
                'new_item_name'      => 'نام آزمون جدید',
                'parent_item'        => 'آزمون مادر',

                'new_item'           => 'آزمون جدید',
                'not_found'          => 'آزمونی یافت نشد',
                'not_found_in_trash' =>  'آزمونی یافت نشد',
            ),
        ...
        $this
            ...
            ->addTaxonomy('scale', array(
                'labels' => array(
                    'name'               => 'مقیاس های آزمون',
                    'singular_name'      => 'مقیاس آزمون',
