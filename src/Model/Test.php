...
class WpTesting_Model_Test extends WpTesting_Model_AbstractParent
{
    ...
    public function isUserLoginForQuestions()
    {
        return $this->isOptionEnabled('wpt_test_page_user_is_login');
    }
    ...
    public function rowShowScales()
    {
        return $this->isOptionEnabled('wpt_result_page_rowShowScales');
    }
